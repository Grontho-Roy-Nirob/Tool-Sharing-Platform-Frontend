...
//     >
//       {/* Badge */}
//       <div className="mb-7 inline-flex items-center gap-2 rounded-full border border-[#292b30] bg-[#0d0e10] px-4 py-2 text-sm text-[#a5a5ab] shadow-[0_8px_30px_rgba(0,0,0,0.18)]">
//         <span className="size-1.5 rounded-full bg-white" aria-hidden="true" />
//         Share tools. Build together.
//       </div>

//       {/* Heading */}
//       <h1 className="max-w-5xl text-balance text-[clamp(3.5rem,8vw,7.25rem)] font-medium leading-[0.94] tracking-[-0.075em] text-white">
//         The tools you need, shared by people around you.
//       </h1>

//       {/* Description */}
//       <p className="mt-8 max-w-2xl text-pretty text-lg leading-8 tracking-[-0.02em] text-[#96979f] sm:text-xl">
...
//       {/* Bottom Label */}
//       <div className="mt-20 flex items-center gap-3 text-sm tracking-wide text-[#686a72]">
//         <span className="h-px w-8 bg-[#292b30]" aria-hidden="true" />
