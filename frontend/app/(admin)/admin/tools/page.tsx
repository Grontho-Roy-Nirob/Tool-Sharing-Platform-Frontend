            ...
            <div className="mx-auto max-w-[1280px]">
              ...
              <section className="overflow-hidden rounded-[22px] bg-white shadow-[0_8px_28px_rgba(55,45,30,0.055)]">
                ...
                <div className="border-b border-[#eee8e1] px-4 py-4 sm:px-5">
                  <div>
                    <h2 className="text-sm font-bold text-[#25231f] sm:text-base">
                      Manage Tools
                    </h2>

                    <p className="mt-1 text-[11px] leading-5 text-[#9a948b] sm:text-xs">
                      Review submitted tools and update their approval status.
                    </p>
                  </div>
                </div>
              ...
              <div className="mt-5 flex items-center justify-center gap-2">
                ...
                <p className="text-center text-[10px] text-[#9a948b]">
                  Review and manage owner-submitted tools from your ToolShare
                  admin workspace.
                </p>
